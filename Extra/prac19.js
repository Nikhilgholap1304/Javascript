...
// console.log(document.childNodes[document.childNodes.length - 1] === document.lastChild) //true

console.log(document.body.hasChildNodes()) //true

console.log(Array.from(document.body.childNodes)) //from nodelist to js array
